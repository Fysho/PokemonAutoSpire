...
export type HatchEvolutionRule = EvolutionRuleCommon & {
  ...
  /* Spire: optional fixed turn counter for timer-based evolutions (Tandemaus/Maushold),
   * replacing the old TimerEvolutionRule class. When set, getHatchTime() returns this
   * instead of the default EVOLVE_HATCH. See 6.9→6.10 migration doc. */
  hatchTime?: number
}
