...
export enum Transfer {
  ...
  AUTOWAVE_NEXT_ROUND = "AUTOWAVE_NEXT_ROUND",
  AUTOWAVE_MATCHUP = "AUTOWAVE_MATCHUP",
  AUTOWAVE_PREDICT = "AUTOWAVE_PREDICT",
  AUTOWAVE_RESULT = "AUTOWAVE_RESULT",
  ...
  REROLL_BOSS_REWARD = "REROLL_BOSS_REWARD",
  PASS_REWARD = "PASS_REWARD",
  ENTER_ELITE_FOUR = "ENTER_ELITE_FOUR",
  ENTER_ACT_5 = "ENTER_ACT_5",
  SKIP_TO_ACT = "SKIP_TO_ACT",
  GAME_SPEED = "GAME_SPEED",
  RESET_CHAMPION = "RESET_CHAMPION",
  GIVE_MEWTWO = "GIVE_MEWTWO",
  ADMIN_HEAL = "ADMIN_HEAL",
